...
with open('data.csv', 'r') as csv_file:
    csv_reader = csv.DictReader(csv_file)  # Automatically maps CSV rows to dictionary
...
print("CSV data has been converted to JSON.")
...
print("Log messages have been written to the log file.")
