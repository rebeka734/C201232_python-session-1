...
# Function to calculate factorial and handle errors
...
# Example usage
print(f"Factorial of 5 is {calculate_factorial(5)}.")  # Valid input
print(f"Factorial of -5 is {calculate_factorial(-5)}.")  # Invalid input (negative number)
print(f"Factorial of 'abc' is {calculate_factorial('abc')}.")  # Invalid input (non-integer)
